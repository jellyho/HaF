...
This module contains the HAFGemma3 class which inherits from LAP and overrides
...
from haf.models.backbones.gemma3 import get_config as get_gemma3_config
import haf.models.backbones.siglip_gemma3 as _siglip_gemma3
...
class HAFGemma3(HAF):
    ...
    def __init__(self, config: _lap_config.HAFConfig, rngs: nnx.Rngs):
        ...
        # Validate config
        assert "gemma3" in config.paligemma_variant, "HAFGemma3 requires gemma3 variant"
