...
from haf.datasets.vqa.bbox import DIRECTION_PROMPT_PARTS
from haf.datasets.vqa.bbox import ROBOT_BBOX_PROMPT_PARTS_OXE
from haf.datasets.vqa.bbox import bbox_to_text_tf
from haf.datasets.vqa.bbox import direction_from_bbox_tf
from haf.datasets.vqa.bbox import sample_prompt_tf
