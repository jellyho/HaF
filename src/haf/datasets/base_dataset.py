...
from haf.datasets.dataset_configs import get_tfds_name_with_version
from haf.datasets.mixins import DatasetOptionsMixin
from haf.datasets.mixins import DummyStatisticsMixin
from haf.datasets.mixins import RLDSDatasetMixin
from haf.datasets.mixins import TFConfigMixin
from haf.datasets.mixins import TrajectoryIdentifierMixin
from haf.datasets.mixins import ValidationSplitMixin
...
from haf.datasets.utils.rotation_utils import euler_to_r6 as euler_to_rot6d
from haf.datasets.utils.rotation_utils import euler_to_rotation_matrix as _R_from_euler_xyz
from haf.datasets.utils.specs import RldsDatasetSpec
...
from haf.shared.normalize_adapter import check_dataset_statistics
from haf.shared.normalize_adapter import get_dataset_statistics

if TYPE_CHECKING:
    from haf.training.config import DataConfig
    ...
    def __init__(
        ...
        *,  # Force keyword-only arguments
        ...
        if self.state_encoding == StateEncoding.NONE:
            from haf.shared.normalize_adapter import ExtendedNormStats
