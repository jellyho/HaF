...
from haf.policies.policy_adapter import ARPolicy
from haf.policies.transforms.output_transforms import CoTOutputs
import haf.transforms as transforms
...
def create_trained_policy(
    ...
    *,
    ...
    from haf.shared.download import maybe_download
    ...
    if norm_stats is None:
        ...
        from haf.training import checkpoints as _checkpoints
